...
O curso envolve problemas que apresentam um certo grau de dificuldade e elevada quantidade de cálculos, por isso faz necessário que os discentes compreendam:

!!! note "Conhecimentos necessários"
	1. Noções de estatística;
	2. Propriedades dos fluidos (i.e. PVT, FVF, Rs, viscosidade, densidade, gas (id)real)
	3. Propriedade das rochas (Pc, porosidade, permeabilidade relativa, etc.)
	3. Tipos de reservatorios (BLKOIL, Dry — Wet Gas, retrogado, etc)
	4. **MANDATÓRIO** ter conhecimentos (**mínimos**) de MS Excel/Libre Calc, MATLAB, Julia, Python, etc. para resolverem alguns exercícios propostos ao longo do curso, bem como do projeto.

Principalmente, **referente aos projetos** (feitos em grupos de alunos) é desejável que cada grupo *escolha uma linguagem de programação (Python, MATLAB, Excel, ...)* para o desenvolvimento, complemento e execução dos estudos/exercícios propostos.
...
## Metodo de Avaliação da Disciplina

Média aritmética das Avs (Avaliações/provas/projetos)

Nota final (NF) será a **média aritmética**:

$$NF = \frac{AB_1 + AB_2}{2}=
	\begin{cases}\ge 7 &\text{Aprovado,}\\
            	 < 5 &\text{Reprovado,}\\
            	 &\text{Prova final}
	\end{cases}$$
...
Se o aluno que obtiver Nota Final (NF),  $5,00\le NF< 7,00$, terá direito a prestar a Prova Final (PF).

Será considerado aprovado, após a realização da Prova Final (PF), em cada disciplina, o aluno que alcançar média final igual ou superior a 5,5 (cinco inteiros e cinco décimos)

$$PF \ge \frac{5,5 - 0,6\times NF}{0,4}$$

**Obs.:** Conteúdo da PF será o assunto lecionado na disciplina!

## Durante as aulas

- Presença: assinatura de atas.
- Discentes deverão, **OBRIGATORIAMENTE**, assistir aulas e fazer provocações pertinentes ao conteudo da aula, *quem não quer assistir... assine a ata e caia fora da sala de aula!*
- **Chegou atrasado**: entre **mudo** e **desloque-se pelos fundos da sala** de aula.
- **Alimentos** No Bira!
...
md"""
# O que é a Engenharia de Reservatorios?
...
manifest_format = "2.0"
project_hash = "2a74c87a2280816930ed3065555122e07c97deb9"
